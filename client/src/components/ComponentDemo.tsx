    ...
    >
      ...
      >
        ...
        <Divider orientation='horizontal' variant='thick' />
				...
				<Text variant='danger'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam natus rerum vel repellendus ipsam ullam quas ab id non laboriosam ratione culpa at, est similique magni iste pariatur nam dignissimos!</Text>
        {/* <Accordion>
          <AccordionItem>
            <AccordionButton>
              Button
