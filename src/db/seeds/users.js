  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
				...
				{ privilegeId: 2, username: 'cash_partner', password: 'bbd9a27dbb7dde38b450cc35c5269814cf35b472acf63bb02d46b94c5980b498', readableName: 'Generic Unsupervised', createdOn: 1617995021013, updatedOn: 1617995021013, }, // pwd 9GTpY3
